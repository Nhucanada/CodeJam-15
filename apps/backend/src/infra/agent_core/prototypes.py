...
def get_action_generation_prompt(_: str) -> Prompt:
    return prompt_prototype_factory(
        "",
        description="Generate a structured cocktail action based on user request.",
        system_message="Generate JSON to represent the user's drink request. Determine the correct action type and provide complete drink details.",
        instructions=(
